...
const Dub = () => {
  ...
  useEffect(() => {
    const loadDestinations = async () => {
      ...
      if (data && !error) {
        ...
        console.error('Error loading dub destinations:', error);
      }
    };
  ...
  const sectionTitle = getSectionTitle('dub', 'EXPLORE DUB');
      ...
      <div className="flex justify-between items-center mb-8">
          ...
          <div>
            ...
            <p className="text-xl text-gray-600 max-w-3xl">
              Discover amazing destinations in the DUB collection
            </p>
          </div>
