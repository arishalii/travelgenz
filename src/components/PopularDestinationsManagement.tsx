...
const PopularDestinationsManagement = () => {
  const [destinations, setDestinations] = useState<PopularDestination[]>([]);
  const [drafts, setDrafts] = useState<Draft[]>([]);
  const [editingItem, setEditingItem] = useState<PopularDestination | null>(null);
  ...
  const loadDrafts = async () => {
    const { data } = await supabase
      .from('drafts')
      .select('*')
      .eq('content_type', 'popular_destinations')
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h3 className="text-xl font-semibold">Popular Destinations Management</h3>
      ...
      <SpreadsheetUpload
        ...
        title="Upload Popular Destinations CSV"
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Duration: {destination.duration}</p>
...
export default PopularDestinationsManagement;