  ...
  return (
    <section className="py-12 bg-gradient-to-br from-orange-50 to-red-50">
      ...
      <div className="text-center mb-8">
          ...
          <p className="text-[1.3rem] leading-7 text-gray-600 max-w-3xl mx-auto">
          ...
          {destinations.map((destination) => (
            ...
            >
              <div className="relative h-48 overflow-hidden">
                ...
                />
                <div className="absolute top-3 right-3 bg-gradient-to-r from-red-500 to-orange-500 text-white px-2 py-1 rounded-full text-xs font-bold flex items-center gap-1">
              ...
              <div className="p-4">
                ...
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span className="text-gray-500 text-sm">• Trending now</span>
                </div>

                <div className="flex items-center justify-between">
                  <div>
                    <div className="flex items-center gap-2">
                      <span className="text-sm line-through text-gray-400">₹{destination.old_price.toLocaleString()}</span>
                      <span className="text-lg font-bold text-red-500">₹{destination.price.toLocaleString()}</span>
                    </div>
                  ...
                  <button 
                    ...
                    className="bg-gradient-to-r from-red-500 to-orange-500 text-white px-3 py-1.5 rounded-lg font-semibold hover:from-red-600 hover:to-orange-600 transition-all flex items-center gap-1 text-sm"
                  >
                    Book Now
        ...
        <div className="text-center mt-8">
          <button 
            ...
            className="bg-gradient-to-r from-red-500 to-orange-500 text-white px-6 py-3 rounded-full font-bold text-lg hover:from-red-600 hover:to-orange-600 transition-all shadow-lg hover:shadow-xl transform hover:scale-105 duration-300"
          >
