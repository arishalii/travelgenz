...
const PopularDestinations = () => {
  ...
  return (
    <section className="py-12 md:pt-4 md:pb-4 bg-white">
          ...
          {destinations.map((destination) => (
            ...
            >
              ...
              <div className="p-4 md:p-6">
                ...
                <h3 className="text-lg md:text-xl font-bold mb-2 group-hover:text-travel-primary transition-colors">
                  {destination.name}
                </h3>
                ...
                <p className="text-gray-600 mb-4 line-clamp-2 text-sm md:text-base">{destination.description}</p>
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                  <div>
                    <div className="flex items-center gap-2">
                      {destination.old_price && (
                        <span className="text-base md:text-lg line-through text-gray-400">₹{destination.old_price.toLocaleString()}</span>
                      )}
                      <span className="text-xl md:text-2xl font-bold text-travel-primary">₹{destination.price.toLocaleString()}</span>
                    </div>
                  ...
                  <button 
                    ...
                    className="bg-travel-primary text-white px-3 md:px-4 py-2 rounded-lg font-semibold hover:bg-travel-primary/90 transition-colors flex items-center gap-2 text-sm md:text-base w-full sm:w-auto justify-center"
                  >
                    Book Now
