...
const Scandinavia = () => {
  ...
  const sectionTitle = getSectionTitle('scandinavia', 'EXPLORE SCANDINAVIA');
  const sectionSubtitle = getSectionSubtitle('scandinavia', 'Discover amazing destinations in the Scandinavia collection');

  return (
    <section className="py-12 md:pt-8 md:pb-10 bg-white">
