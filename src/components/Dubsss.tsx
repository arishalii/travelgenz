...
const Dubsss = () => {
  ...
  useEffect(() => {
    const loadDestinations = async () => {
      ...
      if (data && !error) {
        ...
        console.error('Error loading dubsss destinations:', error);
      }
    };
  ...
  const sectionTitle = getSectionTitle('dubsss', 'EXPLORE DUBSSS');
      ...
      <div className="flex justify-between items-center mb-8">
          ...
          <div>
            ...
            <p className="text-xl text-gray-600 max-w-3xl">
              Discover amazing destinations in the DUBSSS collection
            </p>
          </div>
