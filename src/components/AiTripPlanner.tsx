...
const AiTripPlanner: React.FC = () => {
  ...
  return (
    <section className="py-8 bg-gradient-to-br from-accent-50 to-secondary-50">
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-8">
          ...
          >
            ...
            <span className="text-gray-700 font-medium text-[rgb(6,97,244)]">Human + AI-Powered Trip Planning</span>
          </motion.div>
          <motion.h2 
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          <motion.p
            ...
            viewport={{ once: true }}
            className="text-xl text-gray-600 max-w-[63rem] mx-auto"
          >
          ...
          <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
            <div className="grid grid-cols-1 lg:grid-cols-2">
              <div className="p-6 md:p-8">
                <h3 className="text-xl font-bold mb-6">Your Trip Preferences</h3>
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <label className={`flex items-center justify-center p-3 border rounded-lg cursor-pointer ${travelerType === 'solo' ? 'bg-accent-50 border-accent-500' : 'border-gray-300 hover:bg-gray-50'}`}>
                          <input
                            type="radio"
                            name="travelerType"
                            value="solo"
                        ...
                        <label className={`flex items-center justify-center p-3 border rounded-lg cursor-pointer ${travelerType === 'couple' ? 'bg-accent-50 border-accent-500' : 'border-gray-300 hover:bg-gray-50'}`}>
                          <input
                            type="radio"
                            name="travelerType"
                            value="couple"
                        ...
                        <label className={`flex items-center justify-center p-3 border rounded-lg cursor-pointer ${travelerType === 'family' ? 'bg-accent-50 border-accent-500' : 'border-gray-300 hover:bg-gray-50'}`}>
                          <input
                            type="radio"
                            name="travelerType"
                            value="family"
                        ...
                        <label className={`flex items-center justify-center p-3 border rounded-lg cursor-pointer ${travelerType === 'friends' ? 'bg-accent-50 border-accent-500' : 'border-gray-300 hover:bg-gray-50'}`}>
                          <input
                            type="radio"
                            name="travelerType"
                            value="friends"
                    ...
                    <Button
                      type="submit"
                      className="w-full text-white font-semibold py-3 px-6 rounded-full bg-gradient-to-r from-pink-500 to-purple-500 hover:opacity-90 transition"
                    >
                      Generate Trip Plan
                    </Button>
                  </div>
              ...
              <div className="p-6 md:p-8 bg-gradient-to-br from-blue-500 via-blue-600 to-purple-700 text-white overflow-y-auto max-h-[600px]">
                {!showResults ? (
                  ...
                  <div>
                    <div className="mb-6">
                      <h3 className="text-2xl font-bold mb-2">Your {tripPlan?.duration}-Day {tripPlan?.destination} Adventure</h3>
                      <p className="opacity-90">
                    ...
                    <div className="space-y-6">
                      {tripPlan?.itinerary.map((day) => (
                        <div key={day.day} className="bg-white/10 rounded-lg p-4">
                          ...
                          <div className="text-sm opacity-80 border-t border-white/20 pt-2 mt-2 flex justify-between">
                    ...
                    <div className="mt-6 bg-white/20 rounded-lg p-4">
                      <div className="flex justify-between items-center">
                        ...
                        <span className="text-xl font-bold">${tripPlan?.totalCost}</span>
                      </div>
