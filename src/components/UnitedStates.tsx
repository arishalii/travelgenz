...
const UnitedStates = () => {
  ...
  const sectionTitle = getSectionTitle('united-states', 'EXPLORE UNITED STATES');
  const sectionSubtitle = getSectionSubtitle('united-states', 'Discover amazing destinations in the United States collection');
