...
-- Drop the existing function before recreating it with the corrected logic
DROP FUNCTION IF EXISTS public.get_all_bookings_with_details();

-- Recreate the function to include the new 'applied_coupon_details' column
