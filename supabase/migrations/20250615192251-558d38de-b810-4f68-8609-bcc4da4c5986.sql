...
-- Add a new column to the cart to distinguish between items just added to cart and items that are part of a booking request.
ALTER TABLE public.cart ADD COLUMN IF NOT EXISTS booking_type TEXT NOT NULL DEFAULT 'cart';
...
-- Recreate the function to include the new 'booking_type' column
